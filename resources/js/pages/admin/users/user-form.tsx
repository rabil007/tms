    ...
    return (
        <form onSubmit={onSubmit} className="mx-auto w-full max-w-2xl">
            ...
            <FormCard>
                ...
                <FormField id="email" label="Email address" error={errors.email} className="mt-6">
                    <Input
                        id="email"
                        type="email"
                        value={data.email}
                ...
                <FormField
                    ...
                    className="mt-6"
                >
                    <Select value={data.role_id} onValueChange={(value) => onChange('role_id', value)}>
                        <SelectTrigger
                            id="role_id"
                ...
                <FormField
                    ...
                    hint={requirePassword ? undefined : 'Leave blank to keep the current password'}
                ...
                >
                    <Input
                        ...
                        className={formInputClassName(!!errors.password_confirmation)}
                        autoComplete="new-password"
